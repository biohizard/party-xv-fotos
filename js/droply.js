        ...
        var droply = {
            init: function() {
                droply.config = $.extend({
                    allowedFileSize: 1024 * 1024 * 100, // (100 MB)
                    delay: 5000,
                    progressSpeed: 10,
                    multi: true,
                    request: [],
                    ...
                    label: 'Puedes subir fotografías en formato JPG, PNG o GIF.',
                    dropBox: { title: 'Pon tus fotografías aquí', height: 100, fontSize: 26 },
